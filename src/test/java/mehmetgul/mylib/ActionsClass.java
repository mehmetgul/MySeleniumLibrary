...
public class ActionsClass {
	public static void main(String[] args) throws InterruptedException {
		...
		a.moveToElement(driver.findElement(By.cssSelector("body.desktop.gh-flex:nth-child(2) div.main-content:nth-child(10) div.hl-cat-nav:nth-child(1) ul.hl-cat-nav__container:nth-child(1) > li.hl-cat-nav__js-tab:nth-child(3)"))).build().perform();
